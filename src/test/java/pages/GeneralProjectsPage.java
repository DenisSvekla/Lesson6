...
public class GeneralProjectsPage extends BasePage {

    private static final By PAGE_OPENED_IDENTIFIER = By.xpath("//a[@onclick='this.blur(); " +
            "App.Admin.addExampleProject(); return false;']");
    private static String ENDPOINT = "/admin/projects/overview";
    private By SUCCESSFULLY_MESSAGE_FOR_ADD_PROJECT = By.xpath("//div[text()='Successfully added the new project.']");
    ...
    private By SUCCESSFULLY_MESSAGE_FOR_DELETE_PROJECT = By.xpath("//div[text()='Successfully deleted the project.']");



    public GeneralProjectsPage(WebDriver driver) {
        super(driver);
    }

    public GeneralProjectsPage(WebDriver driver, boolean openPageByUrl) {
    ...
    public WebElement getSuccessfullyMessageAboutAddingProject () {return driver.findElement(SUCCESSFULLY_MESSAGE_FOR_ADD_PROJECT);}
    public WebElement getSuccessfullyMessageAboutDeleteProject () {return driver.findElement(SUCCESSFULLY_MESSAGE_FOR_DELETE_PROJECT);}
