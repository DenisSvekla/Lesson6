...
public class DashboardPage extends BasePage {
    ...
    public WebElement getMostActiveButton() {
        return driver.findElement(MOST_ACTIVE_BUTTON);
    }

    public WebElement getDownloadImgButton() {
        return driver.findElement(DOWNLOAD_IMG_BUTTON);
    }

    public WebElement getDownloadCsvButton() {
        return driver.findElement(DOWNLOAD_CSV_BUTTON);
    }
