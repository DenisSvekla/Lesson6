...
//    }
    ...
    public void test2() throws FileNotFoundException {
        ...
        $(byText("aaz")).innerText();
        $(byText("aaz")).innerHtml();
        $(byText("aaz")).scrollTo();
        $(byText("aaz")).closest("tr");
        $(byText("aaz")).find(By.xpath(""));
        $(byText("aaz")).doubleClick();
        $(byText("aaz")).contextClick();
        $(byText("aaz")).hover();

        $(byText("aaz")).uploadFile(new File(""));
        $(byText("aaz")).download();
