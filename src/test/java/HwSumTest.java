...
public class HwSumTest extends BaseTest{
    ...
    public void sumPositiveDigitsTest() {
        ...
        Assert.assertEquals(ss,9,"Сложение работает некорректно");
    }
    ...
    public void sumOfZerosTest() {
        ...
        Assert.assertEquals(ss,0,"Сложение работает некорректно");
    }
    ...
    public void sumTwo_DigitsThree_DigitsTest(int a,int b, int expectedResult) {
        ...
        Assert.assertEquals(ss,expectedResult,"Сложение работает некорректно");
    }
